...
class BusAdapterDecor(val context: Context, var spacing: Float, var margin: Float) : RecyclerView.ItemDecoration() {
    ...
    init {
        ...
        paint.color = ContextCompat.getColor(context, R.color.item_bus_divider_background)
